...
Currently seeded: `value-proposition.md` (from the creator brief).

Document contract and editing rules: `../README.md`. Who writes: agents via reviewed PRs only;
the spotify-mix-domain analyst is the primary proposer.
