...
Revision date: 2026-08-03. Map from topic → owning document → related skills. One conclusion,
one owner; other documents link rather than restate.

## Distribution model (descriptive — never a direct lever)
...
| Topic | Document | Status |
|---|---|---|
| Recommendation eligibility | `platform-constraints/eligibility.md` | seeded (vertical slice) |
